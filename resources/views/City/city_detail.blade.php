    ...
    <tbody>
        ...
        <tr class="detail_tr">
            ...
            <td><button type="button" class="btn btn-primary btn-sm show-detail" id="{{ $travelDetail->record_id }}" data-toggle="modal" data-target="#myModal">显示详细</button>
                <button type="button" class="btn btn-warning btn-sm show-detail" id="{{ $travelDetail->record_id }}" data-toggle="modal" data-target="#myModal">修改</button>
                <button type="button" class="btn btn-danger btn-sm show-detail" id="{{ $travelDetail->record_id }}" data-toggle="modal" data-target="#myModal">删除</button>
            </td>
        </tr>
        @endforeach
    </tbody>
